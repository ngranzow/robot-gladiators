...
var fight = function(enemy) {
        ...
        if (enemy.health <= 0) {
            ...
            window.alert(enemy.name + " shill has " + enemy.health + " health left.");
        }
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt (
        "Would you like ot REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one 1 for REFILL, 2 for UPGRADE, or 3 for LEAVE."
    );
